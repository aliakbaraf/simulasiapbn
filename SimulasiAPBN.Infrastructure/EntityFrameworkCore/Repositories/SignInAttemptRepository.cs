...
{
    public class SignInAttemptRepository : GenericRepository<SignInAttempt>, ISignInAttemptRepository<RepositoryOptions>
    {
        ...
        public SignInAttempt SignIn(Account account, string password, string userAgent, IPAddress ipAddress)
        {
            ...
            signInAttempt.IsSuccess = account.Password.Validate(password);
