...
namespace SimulasiAPBN.Infrastructure.EntityFrameworkCore.Repositories
{
        ...
        : GenericRepository<SimulationConfig>, ISimulationConfigRepository<RepositoryOptions>
    {
        ...
        public async Task<decimal> GetDeficitThresholdAsync()
        {
            ...
            return decimal.TryParse(deficitThresholdConfig.Value, out var deficitThreshold)
                ? deficitThreshold
                : decimal.One;
        }
        ...
        public async Task<decimal> GetGrossDomesticProductAsync()
        {
            ...
            return decimal.TryParse(grossDomesticProductConfig.Value, out var grossDomesticProduct)
