...
{
	public class SimulationSpecialPolicyAllocationValidator : Validator<SimulationSpecialPolicyAllocation>
	{
		public SimulationSpecialPolicyAllocationValidator()
		{
			RuleFor(model => model.Id)
				.NotNull()
				.WithMessage("Identitas Alokasi Kebijakan Khusus diperlukan.");
			RuleFor(model => model.Id)
				.NotEmpty()
				.WithMessage("Identitas Alokasi Kebijakan Khusus diperlukan.");
