...
// Set up Application Shell-style routing, so that all navigation requests
...
registerRoute(
	...
	({ request, url }: { request: Request; url: URL }) => {
		...
		// If this is a URL that starts with these exception list, skip.
		if (
...
registerRoute(
	...
	({ url }) =>
		url.origin === self.location.origin && (url.pathname.endsWith(".png") || url.pathname.endsWith(".webp")),
